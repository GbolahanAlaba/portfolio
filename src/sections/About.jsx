        ...
        <div className={styles.grid}>
          <div className={`reveal ${isVisible ? "visible" : ""} reveal-delay-1`}>
            <h2 className="section-title">
              Engineer with a{" "}
              <em className={styles.em}>purpose</em>
            </h2>
            ...
            <div className={styles.socials}>
              ...
              <a href={personal.twitter} target="_blank" rel="noreferrer" className={styles.socialLink}>
                <TwitterIcon /> Twitter
              </a>
            </div>
          </div>

          <div className={`reveal ${isVisible ? "visible" : ""} reveal-delay-2`}>
            ...
            <div className={styles.sdgMission}>
              <div className={styles.missionIcon}>
                <EarthIcon />
              </div>
              <div>
                <p className={styles.missionTitle}>SDG Advocate</p>
                <p className={styles.missionText}>
                  Actively aligning every project with the UN's 2030 Agenda for
                  Sustainable Development — from clean code to clean energy solutions.
                </p>
              </div>
            </div>
          </div>
